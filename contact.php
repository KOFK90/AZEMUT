...
if(trim($first_name) == '') {
	...
	echo '<div class="error_message">Attention! Entrez une adresse e-mail valide.</div>';
	exit();
} else if(!isEmail($email)) {
	echo '<div class="error_message">Attention! Adresse e-mail invalide, Reéssayez !.</div>';
	exit();
}

if(trim($comments) == '') {
	echo '<div class="error_message">Attention! Entrez votre texte de message.</div>';
	exit();
}
